...
Tree.prototype.map = function(callback, result) {
  // TODO: return a new tree with the same structure as `this`,
  //       with values generated by the callback
  if(result == undefined)  result = new Tree(callback(this.value))
  else result.addChild(callback(this.value))
  this.children.map(child => {
    return child.map(callback, result)
  })
  return result;
};
